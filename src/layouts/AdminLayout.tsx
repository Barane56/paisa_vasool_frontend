...
const NAV_ITEMS = [
  ...
  { to: ROUTES.ADMIN_INCIDENTS, icon: AlertTriangle, label: 'Cases'         },
    ...
    >
      ...
      <div className={clsx('flex items-center gap-3 transition-all duration-300 border-b', collapsed ? 'px-3 py-4 justify-center' : 'px-4 py-4')} style={{ borderColor: SB_BORDER }}>
        ...
        {!collapsed && (<div className="flex-1 min-w-0">
          ...
          <span className="text-[10px] font-semibold tracking-widest uppercase text-brand-600">Admin Panel</span>
        </div>)}
        {!collapsed && (
      ...
      <nav className="flex-1 py-4 px-2 space-y-0.5">
        {!collapsed && <p className="text-[10px] font-bold uppercase tracking-widest px-3 pb-2" style={{ color: SB_MUTED }}>Admin Tools</p>}
        ...
        {!collapsed && user && (
          <div className="flex items-center gap-2.5 px-3 py-2.5 mb-1 rounded-xl bg-white border" style={{ borderColor: SB_BORDER }}>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-[10px] truncate text-brand-600">Administrator</p>
            </div>
          </div>
        )}
